...
public class WaiverDialog extends android.support.v4.app.DialogFragment {
    ...
    public interface SetTrialInfoListener {
        void onJoinClick(WaiverDialog dialogFragment);
    }
    ...
    @SuppressLint("ValidFragment")
    public WaiverDialog(String title, String desc, String researcher, String institute, long startTime) {
        this.title = title;
        this.desc = desc;
                ...
                .setPositiveButton("Join", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        if (setTrialInfoListener != null) {
                            setTrialInfoListener.onJoinClick(WaiverDialog.this);
                        }
                    }
                })
